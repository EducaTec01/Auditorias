...
class FormulariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create formulario" do
    assert_difference("Formulario.count") do
      post formularios_url, params: { formulario: { fecha: @formulario.fecha, noAuditoria: @formulario.noAuditoria, proceso: @formulario.proceso } }
    end
  ...
  test "should update formulario" do
    patch formulario_url(@formulario), params: { formulario: { fecha: @formulario.fecha, noAuditoria: @formulario.noAuditoria, proceso: @formulario.proceso } }
